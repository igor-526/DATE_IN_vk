...
prmd_children_router = DefaultRouter()


@simple_bot_handler(prmd_children_router, None, filters.EventTypeFilter('message_event'),
                    filters.PayloadFilter({'command': 'back'}),
                    StateFilter(fsm=fsm, state=Profile.d_m_children, for_what=ForWhat.FOR_USER))
...
@simple_bot_handler(prmd_children_router, None, filters.EventTypeFilter('message_event'),
                    filters.PayloadFilter({'command': 'yes'}),
                    StateFilter(fsm=fsm, state=Profile.d_m_children, for_what=ForWhat.FOR_USER))
...
@simple_bot_handler(prmd_children_router, None, filters.EventTypeFilter('message_event'),
                    filters.PayloadFilter({'command': 'plan'}),
                    StateFilter(fsm=fsm, state=Profile.d_m_children, for_what=ForWhat.FOR_USER))
async def plan(event: SimpleBotEvent):
    data = await fsm.get_data(event=event, for_what=ForWhat.FOR_USER)
...
@simple_bot_handler(prmd_children_router, None, filters.EventTypeFilter('message_event'),
                    filters.PayloadFilter({'command': 'no'}),
                    StateFilter(fsm=fsm, state=Profile.d_m_children, for_what=ForWhat.FOR_USER))
...
@simple_bot_message_handler(prmd_children_router,
                            StateFilter(fsm=fsm, state=Profile.d_m_children, for_what=ForWhat.FOR_USER))
