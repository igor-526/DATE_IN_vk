...
prof_set_keys.add_row()
prof_set_keys.add_text_button(text="Дополнительно", payload={"command": "desc_more"}, color=ButtonColor.SECONDARY)
prof_set_keys.add_text_button(text="Фильтры", payload={"command": "filters"}, color=ButtonColor.SECONDARY)
prof_set_keys.add_row()
